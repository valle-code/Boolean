...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2022 a las 12:34:58
...
INSERT INTO `usuario` (`id`, `nombre`, `apellidos`, `email`, `contraseña`, `foto`, `estado`, `ban`) VALUES
...
(19, 'Sonia', 'Perez', 'sonia@sonia.com', 'e9df320409582388be98970f61224faddf107332', 'default.png', 'user', 'No'),
(20, 'Aitor', 'Paz', 'aitor@aitor.com', '9f9d12fa9b85d230ee4d99e28c27c0843f7fdddb', 'default.png', 'user', 'No'),
...
--
ALTER TABLE `noticia`
  ADD CONSTRAINT `noticia_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `usuario` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;

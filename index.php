    ...
    <div class="contenedor">
        <div id="nav-row">
            <div class="navegacion">
                <a href="./index.php"><img src="./Usuario/imagenes/LogoDani-02.png" class="logo" /></a>
                <nav>
                    <ul>
                        <li class="barra" id="barra1">
                            <a href="./Usuario/noticias.php" class="decBarra">Noticias</a>
                        </li>

                        <li class="barra" id="barra2">
                            <a href="./Usuario/crearNoticia.php" class="decBarra">Crear</a>
                        </li>
                        <!-- <li class="barra">
                        ...
                        <li class="barra" id="barra3">
                            <a href="./Usuario/contacto.php" class="decBarra">Contacto</a>
                        </li>
                        ...
                        ?>
                                <li class="barra" id="barra4">
                                    <a href="./Usuario/usuarios.php" class="decBarra">Usuarios</a>
                                </li>
                        <?php }
                        } ?>
                    </ul>
        ...
        <main>
            <div class="columna">
                ...
                <div id="botones">
                    <div class="btnLogin">
                        ...
                        <?php } else { ?>
                            <a href="./Usuario/login.php" class="boton">Iniciar sesión</a>
                        <?php } ?>
                    </div>
                    <div class="btnReg">
                        <a href="./Usuario/registro.php" class="boton">Registrarse</a>
                    </div>
                </div>
            </div>
            <!--Columna derecha-->
            <div class="columna" id="noticias">
                <div class="arreglo">
                    ...
                    ?>
                            <a href="./Usuario/articulo.php?id=<?php echo $fila['id'] ?>">
                                <div class="wrapper" style="background-image: url('./Usuario/Resources/Noticias/<?php echo ($fila['titulo']) ?>/<?php echo ($fila['imagen']) ?>')">
